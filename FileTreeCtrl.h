#if !defined(AFX_FILETREECTRL_H_67F618C6_F36A_4BE3_9913_BC975EE767C7_INCLUDED_)
#define AFX_FILETREECTRL_H_67F618C6_F36A_4BE3_9913_BC975EE767C7_INCLUDED_
...
public:
	...
	void AddHidFolder(int nFolder, CString strPath=_T(""));
	void FreeHidFoldersList();
	BOOL RefreshTree();
 	static int CALLBACK TreeViewCompareProc(LPARAM, LPARAM, LPARAM);
	CString GetInfo(HTREEITEM hItem);

	INT_PTR GetSelectedFiles(std::vector<CString> * SelFiles);
	INT_PTR GetSelectedFolders(std::vector<CString> * SelFolders);
...
#endif // !defined(AFX_FILETREECTRL_H_67F618C6_F36A_4BE3_9913_BC975EE767C7_INCLUDED_)
